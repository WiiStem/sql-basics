...
-- This is dangerous because you can't use rollback if you delete a table
...
-- Write your SQL here.
UPDATE employees SET hire_date = hire_date + INTERVAL 1 WEEK WHERE first_name = 'Sandy' AND last_name = 'Cheeks';
...
-- Write your SQL here. 
update employees set hire_date = current_date, hourly_pay = 10.17 where first_name = "Pearl" AND last_name="Krabs";
