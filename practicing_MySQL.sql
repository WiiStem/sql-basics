...
*/
-- Answer
drop table if exists learning_lab;
...
*/
-- Answer
alter table campers modify column email varchar(120) FIRST /*AFTER last_name*/;

/* 8) Move a column to first position.
   - Make email the first column.
*/
-- Answer
alter table campers modify column email varchar(100) FIRST /*BEFORE camper_id*/;
...
*/
-- Answer
insert into campers values (127, "Jeff", "Smith", 87.20, "2025-06-09");
...
(128, "Tom", "Heisler", 97.00, "2025-06-10"),
(129, "Bob", "Hanks", 99.99, "2025-06-12"),
(130, "Liam", "Williams", 90.50, "2025-06-15"),
(131, "James", "Heisler", 94.90, "2025-06-20");
/* 14) Insert with specific columns only.
   - Insert a row with ONLY camper_id, first_name, last_name (leave others NULL):
*/
insert into campers (camper_id, first_name, last_name) values (132, "jordan", "micheal");
...
-- Answer
-- Bad Attempt:
-- insert into campers values (133, "Tom", "Hiddleston");

-- Good Attempt:
insert into campers (camper_id, first_name, last_name) values (133, "Tom", "Hiddleston");
