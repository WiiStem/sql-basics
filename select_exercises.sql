...
*/
-- Your query below:
select * from people where nameFirst = "Babe" and nameLast = "Ruth";
...
*/
-- Your query below:
select * from batting where HR > 30;
...
*/
-- Your query below:
select * from pitching where ERA < 2.50;
...
*/
-- Your query below:
select teamID, name, yearID from teams where LgID not LIKE "AL";
...
*/
-- Your query below:
select nameFirst, nameLast from people where debut_date < "1950-01-01";
...
*/
-- Your query below:
select nameFirst, nameLast from people where death_date is Null;
...
*/
-- Your query below:
select playerID, yearID from batting where HR > 40 and lgID LIKE "AL";